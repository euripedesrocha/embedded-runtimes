...
package Interfaces.LPC43xxC.RTC is
   pragma Preelaborate;
   ...
   type CCR_Register is record
      --  Clock Enable.
      CLKEN      : ENUM := Interfaces.LPC43xxC.RTC.Disabled;
      --  CTC Reset.
      CTCRST     : ENUM_1 := Interfaces.LPC43xxC.RTC.No_Effect;
      --  Internal test mode controls. These bits must be 0 for normal RTC
      --  operation.
      RESERVED   : CCR_RESERVED_Field := 16#0#;
      --  Calibration counter enable.
      CCALEN     : ENUM_2 := Interfaces.LPC43xxC.RTC.Enabled;
   ...
   type CALIBRATION_Register is record
      ...
      --  Calibration direction
      CALDIR         : ENUM_3 := Interfaces.LPC43xxC.RTC.Forward_Calibration;
      --  unspecified
   ...
   type ERCONTRO_Register is record
      ...
      INTWAKE_EN0  : ENUM := Interfaces.LPC43xxC.RTC.Disabled;
      --  Enables automatically clearing the RTC general purpose registers when
      --  an event occurs on channel 0.
      GPCLEAR_EN0  : ENUM := Interfaces.LPC43xxC.RTC.Disabled;
      --  Selects the polarity of an event on input pin WAKEUP0.
      POL0         : ENUM_6 := Interfaces.LPC43xxC.RTC.Negative;
      ...
      ERMODE       : ENUM_7 := Interfaces.LPC43xxC.RTC.Disable_Event_Monito;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
