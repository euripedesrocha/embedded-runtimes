...
package Interfaces.LPC43.CGU is
   pragma Preelaborate;
   ...
   type FREQ_MON_Register is record
      ...
      --  Measure frequency
      MEAS     : ENUM := Interfaces.LPC43.CGU.Rcnt_And_Fcnt_Disabl;
      --  Clock-source selection for the clock to be measured. All other values
      --  are reserved.
      CLK_SEL  : ENUM_1 := Interfaces.LPC43.CGU.ENUM_32_Khz_Oscillator_D;
      --  Reserved
   ...
   type XTAL_OSC_CTRL_Register is record
      ...
      ENABLE   : ENUM_2 := Interfaces.LPC43.CGU.Power_Down;
      --  Configure crystal operation or external-clock input pin XTAL1. Do not
      --  change the BYPASS and ENABLE bits in one write-action: this will
      --  result in unstable device operation!
      BYPASS   : ENUM_3 := Interfaces.LPC43.CGU.Crystal;
      --  Select frequency range
      HF       : ENUM_4 := Interfaces.LPC43.CGU.High;
      --  Reserved
   ...
   type PLL0USB_CTRL_Register is record
      --  PLL0 power down
      PD         : ENUM_5 := Interfaces.LPC43.CGU.Pll0_Powered_Down;
      --  Input clock bypass control
      BYPASS     : ENUM_6 := Interfaces.LPC43.CGU.Pll0_Input_Clock_Sen;
      --  PLL0 direct input
      ...
      --  Block clock automatically during frequency change
      AUTOBLOCK  : ENUM_7 := Interfaces.LPC43.CGU.Disabled;
      --  Reserved
      RESERVED_2 : PLL0USB_CTRL_RESERVED_Field_2 := 16#0#;
      --  Clock source selection. All other values are reserved.
      CLK_SEL    : ENUM_8 := Interfaces.LPC43.CGU.Irc;
      --  Reserved
   ...
   type PLL0AUDIO_CTRL_Register is record
      ...
      --  Select fractional divider.
      SEL_EXT      : ENUM_9 := Interfaces.LPC43.CGU.Frac_Enabled;
      --  Sigma-Delta modulator power-down
      MOD_PD       : ENUM_10 := Interfaces.LPC43.CGU.Disabled;
      --  Reserved
      RESERVED_2   : PLL0AUDIO_CTRL_RESERVED_Field_2 := 16#0#;
      --  Clock source selection. All other values are reserved.
      CLK_SEL      : ENUM_11 := Interfaces.LPC43.CGU.Irc_Default;
      --  Reserved
   ...
   type PLL1_CTRL_Register is record
      --  PLL1 power down
      PD         : ENUM_12 := Interfaces.LPC43.CGU.Pll1_Powered_Down;
      --  Input clock bypass control
      BYPASS     : ENUM_13 := Interfaces.LPC43.CGU.Input_Clock;
      ...
      --  PLL feedback select.
      FBSEL      : ENUM_14 := Interfaces.LPC43.CGU.Cco_Out;
      --  PLL direct CCO output
      DIRECT     : ENUM_7 := Interfaces.LPC43.CGU.Disabled;
      --  Post-divider division ratio P. The value applied is 2xP.
      PSEL       : ENUM_15 := Interfaces.LPC43.CGU.ENUM_1_1;
      --  Reserved
      RESERVED_2 : PLL1_CTRL_RESERVED_Field := 16#0#;
      --  Block clock automatically during frequency change
      AUTOBLOCK  : ENUM_7 := Interfaces.LPC43.CGU.Disabled;
      --  Pre-divider division ratio N
      NSEL       : ENUM_16 := Interfaces.LPC43.CGU.ENUM_1_1;
      --  Reserved
      ...
      --  Clock-source selection.
      CLK_SEL    : ENUM_17 := Interfaces.LPC43.CGU.Irc_Default;
      --  Reserved
   ...
   type IDIVA_CTRL_Register is record
      --  Integer divider A power down
      PD         : ENUM_18 := Interfaces.LPC43.CGU.Enabled;
      --  Reserved
      RESERVED   : IDIVA_CTRL_RESERVED_Field := 16#0#;
      --  Integer divider A divider values (1/(IDIV + 1))
      IDIV       : ENUM_19 := Interfaces.LPC43.CGU.Div1;
      --  Reserved
      ...
      --  Clock source selection. All other values are reserved.
      CLK_SEL    : ENUM_20 := Interfaces.LPC43.CGU.Irc;
      --  Reserved
   ...
   type IDIVB_CTRL_Register is record
      ...
      --  Clock-source selection. All other values are reserved.
      CLK_SEL    : ENUM_21 := Interfaces.LPC43.CGU.Irc_Default;
      --  Reserved
   ...
   type BASE_USB0_CLK_Register is record
      ...
      --  Clock-source selection.
      CLK_SEL    : ENUM_23 := Interfaces.LPC43.CGU.Pll0Usb;
      --  Reserved
   ...
   type BASE_USB1_CLK_Register is record
      ...
      --  Clock source selection. All other values are reserved.
      CLK_SEL    : ENUM_25 := Interfaces.LPC43.CGU.Irc;
      --  Reserved
   ...
   type BASE_M4_CLK_Register is record
      --  Output stage power down
      PD         : ENUM_26 := Interfaces.LPC43.CGU.Output_Stage_Enabled;
      --  Reserved
      ...
      --  Clock source selection. All other values are reserved.
      CLK_SEL    : ENUM_27 := Interfaces.LPC43.CGU.Irc_Default;
      --  Reserved
   ...
   type BASE_OUT_CLK_Register is record
      ...
      --  Block clock automatically during frequency change
      AUTOBLOCK  : ENUM_28 := Interfaces.LPC43.CGU.Autoblocking_Disable;
      --  Reserved
      RESERVED_1 : BASE_OUT_CLK_RESERVED_Field_1 := 16#0#;
      --  Clock-source selection.
      CLK_SEL    : ENUM_29 := Interfaces.LPC43.CGU.Irc_Default;
      --  Reserved
   ...
   type BASE_AUDIO_CLK_Register is record
      ...
      --  Clock-source selection.
      CLK_SEL    : ENUM_30 := Interfaces.LPC43.CGU.ENUM_32_Khz_Oscillator;
      --  Reserved
