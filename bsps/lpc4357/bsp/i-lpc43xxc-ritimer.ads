...
package Interfaces.LPC43xxC.RITIMER is
   pragma Preelaborate;
   ...
   type CTRL_Register is record
      --  Interrupt flag
      RITINT   : ENUM := Interfaces.LPC43xxC.RITIMER.The_Counter_Value_Do;
      --  Timer enable clear
      RITENCLR : ENUM_1 := Interfaces.LPC43xxC.RITIMER.The_Timer_Will_Not_B;
      --  Timer enable for debug
      RITENBR  : ENUM_2 := Interfaces.LPC43xxC.RITIMER.The_Timer_Is_Halted;
      --  Timer enable.
      RITEN    : ENUM_3 := Interfaces.LPC43xxC.RITIMER.Timer_Enabled_This;
...
end Interfaces.LPC43xxC.RITIMER;
