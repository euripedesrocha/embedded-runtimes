...
package Interfaces.LPC43.MCPWM is
   pragma Preelaborate;
   ...
   type CCP_Register is record
      --  Communication pattern output A, channel 0.
      CCPA0    : ENUM_8 := Interfaces.LPC43.MCPWM.Mcoa0_Passive;
      --  Communication pattern output B, channel 0.
      CCPB0    : ENUM_9 := Interfaces.LPC43.MCPWM.Mcob0_Passive;
      --  Communication pattern output A, channel 1.
      CCPA1    : ENUM_10 := Interfaces.LPC43.MCPWM.Mcoa1_Passive;
      --  Communication pattern output B, channel 1.
      CCPB1    : ENUM_11 := Interfaces.LPC43.MCPWM.Mcob1_Passive;
      --  Communication pattern output A, channel 2.
      CCPA2    : ENUM_12 := Interfaces.LPC43.MCPWM.Mcoa2_Passive;
      --  Communication pattern output B, channel 2.
      CCPB2    : ENUM_13 := Interfaces.LPC43.MCPWM.Mcob2_Passive;
      --  Reserved.
