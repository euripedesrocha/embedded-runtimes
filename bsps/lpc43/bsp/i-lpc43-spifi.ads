...
package Interfaces.LPC43.SPIFI is
   pragma Preelaborate;
   ...
   type CTRL_Register is record
      ...
      --  SPI Mode 3 select.
      MODE3        : ENUM := Interfaces.LPC43.SPIFI.Sck_Low;
      --  Reserved.
      ...
      PRFTCH_DIS   : ENUM_1 := Interfaces.LPC43.SPIFI.Enable;
      --  Select dual protocol.
      DUAL         : ENUM_2 := Interfaces.LPC43.SPIFI.Quad_Protocol;
      --  Select active clock edge for input data.
      RFCLK        : ENUM_3 := Interfaces.LPC43.SPIFI.Rising_Edge;
      --  Feedback clock select.
      FBCLK        : ENUM_4 := Interfaces.LPC43.SPIFI.Feedback_Clock;
   ...
   type CMD_Register is record
      ...
      --  the data:
      DOUT      : ENUM_5 := Interfaces.LPC43.SPIFI.Input_From_Serial_Fl;
      ...
      --  This field controls how the fields of the command are sent.
      FIELDFORM : ENUM_6 := Interfaces.LPC43.SPIFI.All_Serial;
      --  This field controls the opcode and address fields.
      FRAMEFORM : ENUM_7 := Interfaces.LPC43.SPIFI.Reserved;
   ...
   type MCMD_Register is record
      ...
      FIELDFORM : ENUM_6 := Interfaces.LPC43.SPIFI.All_Serial;
      --  This field controls the opcode and address fields.
      FRAMEFORM : ENUM_8 := Interfaces.LPC43.SPIFI.Reserved;
      --  The opcode of the command (not used for some FRAMEFORM values).
