...
package Interfaces.LPC43xxC.C_CAN1 is
   pragma Preelaborate;
   ...
   type CNTL_Register is record
      --  Initialization
      INIT       : ENUM := Interfaces.LPC43xxC.C_CAN1.Initialization_Is_St;
      --  Module interrupt enable
      IE         : ENUM_1 := Interfaces.LPC43xxC.C_CAN1.Disable_Can_Interrup;
      --  Status change interrupt enable
      SIE        : ENUM_2 := Interfaces.LPC43xxC.C_CAN1.Disable_Status_Chang;
      --  Error interrupt enable
      EIE        : ENUM_3 := Interfaces.LPC43xxC.C_CAN1.Disable_Error_Interr;
      --  reserved
      RESERVED   : CNTL_RESERVED_Field := 16#0#;
      --  Disable automatic retransmission
      DAR        : ENUM_4 := Interfaces.LPC43xxC.C_CAN1.Enabled;
      --  Configuration change enable
      CCE        : ENUM_5 := Interfaces.LPC43xxC.C_CAN1.The_Cpu_Has_No_Write;
      --  Test mode enable
      TEST       : ENUM_6 := Interfaces.LPC43xxC.C_CAN1.Normal_Operation;
      --  reserved
   ...
   type STAT_Register is record
      ...
      LEC      : ENUM_7 := Interfaces.LPC43xxC.C_CAN1.No_Error;
      --  Transmitted a message successfully This bit is reset by the CPU. It
      --  is never reset by the CAN controller.
      TXOK     : ENUM_8 := Interfaces.LPC43xxC.C_CAN1.Nomsgtransfer;
      --  Received a message successfully This bit is reset by the CPU. It is
      --  never reset by the CAN controller.
      RXOK     : ENUM_8 := Interfaces.LPC43xxC.C_CAN1.Nomsgtransfer;
      --  Error passive
      EPASS    : ENUM_9 := Interfaces.LPC43xxC.C_CAN1.Active;
      --  Warning status
      EWARN    : ENUM_10 := Interfaces.LPC43xxC.C_CAN1.Both_Error_Counters;
      --  Busoff status
      BOFF     : ENUM_11 := Interfaces.LPC43xxC.C_CAN1.Nobusoff;
      --  reserved
   ...
   type TEST_Register is record
      ...
      --  Basic mode
      BASIC      : ENUM_13 := Interfaces.LPC43xxC.C_CAN1.Basic_Mode_Disabled;
      --  Silent mode
      SILENT     : ENUM_14 := Interfaces.LPC43xxC.C_CAN1.Normal_Operation;
      --  Loop back mode
      LBACK      : ENUM_15 := Interfaces.LPC43xxC.C_CAN1.Disabled;
      --  Control of TD pins
      TX1_0      : ENUM_16 := Interfaces.LPC43xxC.C_CAN1.Level_At_The_Td_Pin;
      --  Monitors the actual value of the RD Pin
      RX         : ENUM_17 := Interfaces.LPC43xxC.C_CAN1.The_Can_Bus_Is_Domin;
      --  Reserved
   ...
   type IF_CMDMSK_W_Register is record
      --  Access data bytes 4-7
      DATA_B    : ENUM_18 := Interfaces.LPC43xxC.C_CAN1.Data_Bytes_4_7_Uncha;
      --  Access data bytes 0-3
      DATA_A    : ENUM_19 := Interfaces.LPC43xxC.C_CAN1.Data_Bytes_0_3_Uncha;
      --  Access transmission request bit
      TXRQST    : ENUM_20 := Interfaces.LPC43xxC.C_CAN1.No_Transmission_Requ;
      --  This bit is ignored in the write direction.
      CLRINTPND : IF_CMDMSK_W0_CLRINTPND_Field := 16#0#;
      --  Access control bits
      CTRL      : ENUM_21 := Interfaces.LPC43xxC.C_CAN1.Control_Bits_Unchang;
      --  Access arbitration bits
      ARB       : ENUM_22 := Interfaces.LPC43xxC.C_CAN1.Arbitration_Bits_Unc;
      --  Access mask bits
      MASK      : ENUM_23 := Interfaces.LPC43xxC.C_CAN1.Mask_Bits_Unchanged;
   ...
   type IF_CMDMSK_R_Register is record
      ...
      DATA_A    : ENUM_19 := Interfaces.LPC43xxC.C_CAN1.Data_Bytes_0_3_Uncha;
      --  Access new data bit
      NEWDAT    : ENUM_24 := Interfaces.LPC43xxC.C_CAN1.Newdat_Bit_Remains_U;
      --  Clear interrupt pending bit.
      CLRINTPND : ENUM_25 := Interfaces.LPC43xxC.C_CAN1.Intpnd_Bit_Remains_U;
      --  Access control bits
      CTRL      : ENUM_21 := Interfaces.LPC43xxC.C_CAN1.Control_Bits_Unchang;
      --  Access arbitration bits
      ARB       : ENUM_22 := Interfaces.LPC43xxC.C_CAN1.Arbitration_Bits_Unc;
   ...
   type IF_MSK_Register_1 is record
      ...
      --  Mask message direction
      MDIR       : ENUM_26 := Interfaces.LPC43xxC.C_CAN1.The_Message_Directio;
      --  Mask extend identifier
      MXTD       : ENUM_27 := Interfaces.LPC43xxC.C_CAN1.The_Extended_Identif;
      --  Reserved
   ...
   type IF_ARB_Register_1 is record
      ...
      --  Message direction
      DIR      : ENUM_28 := Interfaces.LPC43xxC.C_CAN1.Direction_Eq_Receive;
      --  Extend identifier
      XTD      : ENUM_29 := Interfaces.LPC43xxC.C_CAN1.The_11_Bit_Standard;
      ...
      MSGVAL   : ENUM_30 := Interfaces.LPC43xxC.C_CAN1.The_Message_Object_I_1;
      --  Reserved
   ...
   type IF_MCTRL_Register is record
      ...
      --  End of buffer
      EOB        : ENUM_31 := Interfaces.LPC43xxC.C_CAN1.Message_Object_Belon;
      --  Transmit request
      TXRQST     : ENUM_32 := Interfaces.LPC43xxC.C_CAN1.Wait;
      --  Remote enable
      RMTEN      : ENUM_33 := Interfaces.LPC43xxC.C_CAN1.Unchanged;
      --  Receive interrupt enable
      RXIE       : ENUM_34 := Interfaces.LPC43xxC.C_CAN1.Unchanged;
      --  Transmit interrupt enable
      TXIE       : ENUM_34 := Interfaces.LPC43xxC.C_CAN1.Unchanged;
      ...
      UMASK      : ENUM_35 := Interfaces.LPC43xxC.C_CAN1.Mask_Ignored;
      --  Interrupt pending
      INTPND     : ENUM_36 := Interfaces.LPC43xxC.C_CAN1.Nointsource;
      --  Message lost (only valid for message objects in the direction
      --  receive).
      MSGLST     : ENUM_37 := Interfaces.LPC43xxC.C_CAN1.No_Message_Lost_Sinc;
      --  New data
      NEWDAT     : ENUM_38 := Interfaces.LPC43xxC.C_CAN1.No_New_Data_Has_Been;
      --  Reserved
   ...
   type CLKDIV_Register is record
      --  Clock divider value CAN_CLK = PCLK/(CLKDIVVAL +1)i
      --     0000: CAN_CLK = PCLK divided by 1.i
...
end Interfaces.LPC43xxC.C_CAN1;
