...
package Interfaces.LPC43.GPDMA is
   pragma Preelaborate;
   ...
   type CONFIG_Register is record
      --  DMA Controller enable:
      E        : ENUM := Interfaces.LPC43.GPDMA.Disabled_Default;
      --  AHB Master 0 endianness configuration:
   ...
   type CLLI_Register is record
      --  AHB master select for loading the next LLI:
      LM  : ENUM_2 := Interfaces.LPC43.GPDMA.Ahb_Master_0;
   ...
   type CCONTROL_Register is record
      ...
      --  peripheral.
      SBSIZE       : ENUM_3 := Interfaces.LPC43.GPDMA.Source_Burst_1;
      ...
      DBSIZE       : ENUM_4 := Interfaces.LPC43.GPDMA.Destination_Burst_1;
      ...
      --  required. 0x3 to 0x7 - Reserved.
      SWIDTH       : ENUM_5 := Interfaces.LPC43.GPDMA.Byte_8_Bit;
      ...
      DWIDTH       : ENUM_5 := Interfaces.LPC43.GPDMA.Byte_8_Bit;
      --  Source AHB master select:
      S            : ENUM_6 := Interfaces.LPC43.GPDMA.Ahb_Master_0_Selecte;
      --  Destination AHB master select: Only Master1 can access a peripheral.
      --  Master0 can only access memory.
      D            : ENUM_6 := Interfaces.LPC43.GPDMA.Ahb_Master_0_Selecte;
      --  Source increment:
      SI           : ENUM_7 := Interfaces.LPC43.GPDMA.Not_Increment;
      --  Destination increment:
      DI           : ENUM_8 := Interfaces.LPC43.GPDMA.The_Destination_Addr;
      --  Indicates that the access is in user mode or privileged mode:
      PROT1        : ENUM_9 := Interfaces.LPC43.GPDMA.Access_Is_In_User_Mo;
      --  Indicates that the access is bufferable or not bufferable:
      PROT2        : ENUM_10 := Interfaces.LPC43.GPDMA.Access_Is_Not_Buffer;
      --  Indicates that the access is cacheable or not cacheable:
      PROT3        : ENUM_11 := Interfaces.LPC43.GPDMA.Access_Is_Not_Cachea;
      --  Terminal count interrupt enable bit.
      I            : ENUM_12 := Interfaces.LPC43.GPDMA.The_Terminal_Count_I;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   type CCONFIG_Register is record
      ...
      E              : ENUM_13 := Interfaces.LPC43.GPDMA.Channel_Disabled;
      ...
      SRCPERIPHERAL  : ENUM_14 := Interfaces.LPC43.GPDMA.Source_Eq_Spifi;
      ...
      DESTPERIPHERAL : ENUM_15 := Interfaces.LPC43.GPDMA.Destination_Eq_Spifi;
      ...
      FLOWCNTRL      : ENUM_16 := Interfaces.LPC43.GPDMA.Memory_To_Memory;
      ...
      H              : ENUM_17 := Interfaces.LPC43.GPDMA.Enable_Dma_Requests;
