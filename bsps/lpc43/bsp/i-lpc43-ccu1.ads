...
package Interfaces.LPC43.CCU1 is
   pragma Preelaborate;
   ...
   type PM_Register is record
      --  Initiate power-down mode
      PD       : ENUM := Interfaces.LPC43.CCU1.Normal_Operation;
      --  Reserved.
   ...
   type CLK_APB3_BUS_CFG_Register is record
      --  Run enable
      RUN      : ENUM_1 := Interfaces.LPC43.CCU1.Enabled;
      --  Auto (AHB disable mechanism) enable
      AUTO     : ENUM_1 := Interfaces.LPC43.CCU1.Disabled;
      --  Wake-up mechanism enable
      WAKEUP   : ENUM_1 := Interfaces.LPC43.CCU1.Disabled;
      --  Reserved
   ...
   type CLK_M4_EMCDIV_CFG_Register is record
      ...
      --  Clock divider value
      DIV        : DIV_Field := Interfaces.LPC43.CCU1.Divideby1;
      --  Reserved
   ...
   type CLK_USB0_CFG_Register is record
      ...
      RUN      : ENUM_1 := Interfaces.LPC43.CCU1.Enabled;
      --  Auto (AHB disable mechanism) enable
      AUTO     : ENUM_2 := Interfaces.LPC43.CCU1.Auto_Is_Disabled;
      --  Wake-up mechanism enable
      WAKEUP   : ENUM_3 := Interfaces.LPC43.CCU1.Wake_Up_Is_Disabled;
      --  Reserved
