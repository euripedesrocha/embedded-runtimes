...
package Interfaces.LPC43xxC.EMC is
   pragma Preelaborate;
   ...
   type CONTROL_Register is record
      ...
      L        : ENUM_2 := Interfaces.LPC43xxC.EMC.Normal;
   ...
   type CONFIG_Register is record
      --  Endian mode.
      EM         : ENUM_6 := Interfaces.LPC43xxC.EMC.Little_Endian_Mode;
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
   ...
   type DYNAMICCONTROL_Register is record
      ...
      CE         : ENUM := Interfaces.LPC43xxC.EMC.Disabled;
      ...
      CS         : ENUM_7 := Interfaces.LPC43xxC.EMC.Run;
      ...
      SR         : ENUM_8 := Interfaces.LPC43xxC.EMC.Self_Refresh;
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
      RESERVED   : DYNAMICCONTROL_RESERVED_Field := 16#0#;
      --  Memory clock control.
      MMC        : ENUM_9 := Interfaces.LPC43xxC.EMC.Enabled;
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
      RESERVED_1 : DYNAMICCONTROL_RESERVED_Field_1 := 16#0#;
      --  SDRAM initialization.
      I          : ENUM_10 := Interfaces.LPC43xxC.EMC.Normal;
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
   ...
   type DYNAMICREADCONFIG_Register is record
      --  Read data strategy.
      RD       : ENUM_11 := Interfaces.LPC43xxC.EMC.Do_Not_Use;
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
   ...
   type DYNAMICCONFIG_Register is record
      ...
      --  Memory device.
      MD         : ENUM_12 := Interfaces.LPC43xxC.EMC.Sdram;
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
      ...
      --  Buffer enable.
      B          : ENUM := Interfaces.LPC43xxC.EMC.Disabled;
      --  Write protect.
      P          : ENUM_13 := Interfaces.LPC43xxC.EMC.None;
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
   ...
   type DYNAMICRASCAS_Register is record
      --  RAS latency (active to read/write delay).
      RAS        : ENUM_14 := Interfaces.LPC43xxC.EMC.Three_Emc_Cclk_Cycle;
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
      RESERVED   : DYNAMICRASCAS0_RESERVED_Field := 16#0#;
      --  CAS latency.
      CAS        : ENUM_14 := Interfaces.LPC43xxC.EMC.Three_Emc_Cclk_Cycle;
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
   ...
   type STATICCONFIG_Register is record
      --  Memory width.
      MW         : ENUM_15 := Interfaces.LPC43xxC.EMC.ENUM_8_Bit;
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
      ...
      --  signal.
      PB         : ENUM_17 := Interfaces.LPC43xxC.EMC.High;
      ...
      --  transactions.[1]
      EW         : ENUM := Interfaces.LPC43xxC.EMC.Disabled;
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
      ...
      B          : ENUM := Interfaces.LPC43xxC.EMC.Disabled;
      --  Write protect.
      P          : ENUM_18 := Interfaces.LPC43xxC.EMC.None;
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
