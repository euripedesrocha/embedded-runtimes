...
package Interfaces.LPC43.USART is
   pragma Preelaborate;
   ...
   type IER_Register is record
      ...
      RXIE       : ENUM := Interfaces.LPC43.USART.Disable;
      --  Reserved
      ...
      ABEOINTEN  : ENUM := Interfaces.LPC43.USART.Disable;
      --  Enables the auto-baud time-out interrupt.
      ABTOINTEN  : ENUM := Interfaces.LPC43.USART.Disable;
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
   ...
   type FCR_Register is record
      ...
      FIFOEN     : ENUM_3 := Interfaces.LPC43.USART.Disabled;
      --  Write-only. RX FIFO Reset.
      RXFIFORES  : ENUM_4 := Interfaces.LPC43.USART.No_Effect;
      --  Write-only. TX FIFO Reset.
      TXFIFORES  : ENUM_4 := Interfaces.LPC43.USART.No_Effect;
      ...
      --  activated.
      RXTRIGLVL  : ENUM_5 := Interfaces.LPC43.USART.Level_0;
      --  Write-only. Reserved
   ...
   type LCR_Register is record
      --  Word Length Select.
      WLS      : ENUM_6 := Interfaces.LPC43.USART.ENUM_5_Bit_Character_Leng;
      --  Stop Bit Select.
      SBS      : ENUM_7 := Interfaces.LPC43.USART.ENUM_1_Stop_Bit;
      --  Parity Enable
      PE       : ENUM_8 := Interfaces.LPC43.USART.Disable_Parity_Gener;
      --  Parity Select.
      PS       : ENUM_9 := Interfaces.LPC43.USART.Odd_Parity;
      --  Break Control.
      BC       : ENUM_3 := Interfaces.LPC43.USART.Disabled;
      --  Divisor Latch Access Bit.
      DLAB     : ENUM_3 := Interfaces.LPC43.USART.Disabled;
      --  Reserved
   ...
   type ACR_Register is record
      ...
      --  completion.
      START       : ENUM_15 := Interfaces.LPC43.USART.Stop;
      --  Auto-baud mode select bit.
      MODE        : ENUM_16 := Interfaces.LPC43.USART.Mode_0;
      --  Restart bit.
      AUTORESTART : ENUM_17 := Interfaces.LPC43.USART.No_Restart;
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
      RESERVED    : ACR_RESERVED_Field := 16#0#;
      --  End of auto-baud interrupt clear bit (write-only).
      ABEOINTCLR  : ENUM_4 := Interfaces.LPC43.USART.No_Effect;
      --  Auto-baud time-out interrupt clear bit (write-only).
      ABTOINTCLR  : ENUM_4 := Interfaces.LPC43.USART.No_Effect;
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
   ...
   type ICR_Register is record
      --  IrDA mode enable.
      IRDAEN     : ENUM_3 := Interfaces.LPC43.USART.Disabled;
      --  Serial input direction.
      IRDAINV    : ENUM_18 := Interfaces.LPC43.USART.Not_Inverted;
      --  IrDA fixed pulse width mode.
      FIXPULSEEN : ENUM_3 := Interfaces.LPC43.USART.Disabled;
   ...
   type HDEN_Register is record
      ...
      HDEN     : ENUM_3 := Interfaces.LPC43.USART.Disabled;
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
   ...
   type SCICTRL_Register is record
      ...
      SCIEN      : ENUM_3 := Interfaces.LPC43.USART.Disabled;
      --  NACK response disable. Only applicable in T=0.
      NACKDIS    : ENUM_19 := Interfaces.LPC43.USART.Enabled;
      --  Protocol selection as defined in the ISO7816-3 standard.
      PROTSEL    : ENUM_20 := Interfaces.LPC43.USART.T_Eq_0;
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
   ...
   type RS485CTRL_Register is record
      --  NMM enable.
      NMMEN      : ENUM_3 := Interfaces.LPC43.USART.Disabled;
      --  Receiver enable.
      RXDIS      : ENUM_19 := Interfaces.LPC43.USART.Enabled;
      --  AAD enable
      AADEN      : ENUM_3 := Interfaces.LPC43.USART.Disabled;
      --  Reserved.
      RESERVED   : RS485CTRL_RESERVED_Field := 16#0#;
      --  Direction control for DIR pin.
      DCTRL      : ENUM_3 := Interfaces.LPC43.USART.Disabled;
      --  Direction control pin polarity. This bit reverses the polarity of the
      --  direction control signal on the DIR pin.
      OINV       : ENUM_21 := Interfaces.LPC43.USART.Low;
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
   ...
   type SYNCCTRL_Register is record
      ...
      SYNC     : ENUM_3 := Interfaces.LPC43.USART.Disabled;
      --  Clock source select.
      CSRC     : ENUM_22 := Interfaces.LPC43.USART.Slave_Mode;
      --  Edge sampling.
      FES      : ENUM_23 := Interfaces.LPC43.USART.Rising;
      --  Transmit synchronization bypass in synchronous slave mode.
      TSBYPASS : ENUM_24 := Interfaces.LPC43.USART.Synchronized_k;
      --  Continuous master clock enable (used only when CSRC is 1)
      CSCEN    : ENUM_25 := Interfaces.LPC43.USART.On_Character;
      --  Start/stop bits
      SSSDIS   : ENUM_26 := Interfaces.LPC43.USART.Send;
      --  Continuous clock clear
      CCCLR    : ENUM_27 := Interfaces.LPC43.USART.Software;
