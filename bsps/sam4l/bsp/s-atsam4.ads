...
--
--  The file is based on ATSAM4 version by Adacore

pragma Restrictions (No_Elaboration_Code);

with Interfaces.Bit_Types;

package System.ATSAM4 is
   pragma Preelaborate (System.ATSAM4);
   ...
   type CPUSEL_Prescaler_Enum is
   (DIV2,  DIV4,   DIV8,   DIV16,
   DIV64, DIV128, DIV256, DIV512)
   with Size => 3;

   --  AHBPRE_DIV1 : constant AHB_Prescaler :=
   --  (Enabled => False, Value => DIV2);
   ...
   subtype CPUCLK_Range is Integer range           1 .. 48_000_000;
   ...
   RCSYS_Clock : constant := 110_000;
   RC80M_Clock : constant := 80_000_000;
   RC1M_Clock : constant := 1_000_000;
   --  RCFAST_Clock : constant :=

   --  MCU_ID : MCU_ID_Register with Volatile,
   --  Address => System'To_Address (16#E004_2000#);
   --  --    Only 32-bits access supported (read-only)

   --  DEV_ID_ATSAM4F40xxx : constant := 16#413#; --    ATSAM4F40xxx/41xxx
   --  DEV_ID_ATSAM4F42xxx : constant := 16#419#; --    ATSAM4F42xxx/43xxx
   --  DEV_ID_ATSAM4F46xxx : constant := 16#434#; --    ATSAM4F469xx/479xx
   --  DEV_ID_ATSAM4F74xxx : constant := 16#449#; --    ATSAM4F74xxx/75xxx
