...
package Interfaces.LPC43xxC.SCU is
   pragma Preelaborate;
   ...
   type SFSP0_Register is record
      --  Select pin function.
      MODE     : ENUM := Interfaces.LPC43xxC.SCU.Function_0_Default;
      --  Enable pull-down resistor at pad.
      EPD      : ENUM_1 := Interfaces.LPC43xxC.SCU.Disable_Pull_Down;
      --  Disable pull-up resistor at pad. By default, the pull-up resistor is
      --  enabled at reset.
      EPUN     : ENUM_2 := Interfaces.LPC43xxC.SCU.Enable_Pull_Up;
      --  Select Slew rate.
      EHS      : ENUM_3 := Interfaces.LPC43xxC.SCU.Slow_Low_Noise_With;
      --  Input buffer enable. The input buffer is disabled by default at reset
      --  and must be enabled for receiving.
      EZI      : ENUM_4 := Interfaces.LPC43xxC.SCU.Disable_Input_Buffer;
      --  Input glitch filter. Disable the input glitch filter for clocking
      --  signals higher than 30 MHz.
      ZIF      : ENUM_5 := Interfaces.LPC43xxC.SCU.Enable_Input_Glitch;
      --  Reserved
   ...
   type SFSP1_17_Register is record
      ...
      ZIF        : ENUM_5 := Interfaces.LPC43xxC.SCU.Enable_Input_Glitch;
      --  Select drive strength.
      EHD        : ENUM_6 := Interfaces.LPC43xxC.SCU.Normal_Drive_4_Ma_D;
      --  Reserved
   ...
   type SFSP3_3_Register is record
      ...
      EPUN     : ENUM_2 := Interfaces.LPC43xxC.SCU.Enable_Pull_Up;
      --  Slew rate
      EHS      : ENUM_7 := Interfaces.LPC43xxC.SCU.Fast_Low_Noise_With;
      --  Input buffer enable. The input buffer is disabled by default at reset
      --  and must be enabled for receiving.
      EZI      : ENUM_4 := Interfaces.LPC43xxC.SCU.Disable_Input_Buffer;
      --  Input glitch filter. Disable the input glitch filter for clocking
      --  signals higher than 30 MHz.
      ZIF      : ENUM_8 := Interfaces.LPC43xxC.SCU.Enable_Input_Filter;
      --  Reserved
   ...
   type SFSP9_Register is record
      ...
      EPUN       : ENUM_2 := Interfaces.LPC43xxC.SCU.Enable_Pull_Up;
      --  Slew rate
      EHS        : ENUM_9 := Interfaces.LPC43xxC.SCU.Slow;
      --  Input buffer enable. The input buffer is disabled by default at reset
      --  but must be enabled to transfer data from the I/O buffer to the pad.
      EZI        : ENUM_4 := Interfaces.LPC43xxC.SCU.Disable_Input_Buffer;
      --  Reserved
      ...
      --  Select drive strength
      EHD        : ENUM_10 := Interfaces.LPC43xxC.SCU.Standard_Drive_4_Ma;
      --  Reserved
   ...
   type SFSUSB_Register is record
      --  Differential data input AIP/AIM.
      USB_AIM    : ENUM_11 := Interfaces.LPC43xxC.SCU.Going_Low_With_Full;
      --  Control signal for differential input or single input.
      USB_ESEA   : ENUM_12 := Interfaces.LPC43xxC.SCU.Single_Input;
      --  Enable pull-down connect.
      USB_EPD    : ENUM_13 := Interfaces.LPC43xxC.SCU.Pull_Down_Disconnect;
      --  Reserved
      RESERVED   : SFSUSB_RESERVED_Field := 16#0#;
      --  Power mode.
      USB_EPWR   : ENUM_14 := Interfaces.LPC43xxC.SCU.Power_Saving_Mode_S;
      --  Enable the vbus_valid signal. This signal is monitored by the USB1
      ...
      --  register.
      USB_VBUS   : ENUM_15 := Interfaces.LPC43xxC.SCU.Vbus_Signal_Low_Or_I;
      --  Reserved
   ...
   type SFSI2C0_Register is record
      ...
      SCL_ZIF    : ENUM_8 := Interfaces.LPC43xxC.SCU.Enable_Input_Filter;
      ...
      SDA_EHD    : ENUM_17 := Interfaces.LPC43xxC.SCU.Standardfast_Mode;
      --  Enable the input receiver for the SDA pin. Always write a 1 to this
      --  bit when using the I2C0.
      SDA_EZI    : ENUM_18 := Interfaces.LPC43xxC.SCU.Disabled;
      --  Reserved
      ...
      SDA_ZIF    : ENUM_8 := Interfaces.LPC43xxC.SCU.Enable_Input_Filter;
      --  Reserved
   ...
   type ENAIO0_Register is record
      --  Select ADC0_0
      ADC0_0        : ENUM_19 := Interfaces.LPC43xxC.SCU.Digital_Function_Sel;
      --  Select ADC0_1
      ADC0_1        : ENUM_19 := Interfaces.LPC43xxC.SCU.Digital_Function_Sel;
      --  Select ADC0_2
      ADC0_2        : ENUM_19 := Interfaces.LPC43xxC.SCU.Digital_Function_Sel;
      --  Select ADC0_3
      ADC0_3        : ENUM_19 := Interfaces.LPC43xxC.SCU.Digital_Function_Sel;
      --  Select ADC0_4
      ADC0_4        : ENUM_19 := Interfaces.LPC43xxC.SCU.Digital_Function_Sel;
      --  Select ADC0_5
      ADC0_5        : ENUM_19 := Interfaces.LPC43xxC.SCU.Digital_Function_Sel;
      --  Select ADC0_6
      ADC0_6        : ENUM_19 := Interfaces.LPC43xxC.SCU.Digital_Function_Sel;
      --  unspecified
   ...
   type ENAIO1_Register is record
      --  Select ADC1_0
      ADC1_0        : ENUM_20 := Interfaces.LPC43xxC.SCU.Digital_Function_Sel;
      --  Select ADC1_1
      ADC1_1        : ENUM_20 := Interfaces.LPC43xxC.SCU.Digital_Function_Sel;
      --  Select ADC1_2
      ADC1_2        : ENUM_20 := Interfaces.LPC43xxC.SCU.Digital_Function_Sel;
      --  Select ADC1_3
      ADC1_3        : ENUM_20 := Interfaces.LPC43xxC.SCU.Digital_Function_Sel;
      --  Select ADC1_4
      ADC1_4        : ENUM_20 := Interfaces.LPC43xxC.SCU.Digital_Function_Sel;
      --  Select ADC1_5
      ADC1_5        : ENUM_20 := Interfaces.LPC43xxC.SCU.Digital_Function_Sel;
      --  Select ADC1_6
      ADC1_6        : ENUM_20 := Interfaces.LPC43xxC.SCU.Digital_Function_Sel;
      --  Select ADC1_7.
      ADC1_7        : ENUM_20 := Interfaces.LPC43xxC.SCU.Digital_Function_Sel;
      --  unspecified
   ...
   type ENAIO2_Register is record
      --  Select DAC
      DAC           : ENUM_21 := Interfaces.LPC43xxC.SCU.Digital_Function_Sel;
      --  unspecified
      ...
      BG            : ENUM_22 := Interfaces.LPC43xxC.SCU.Digital_Function_Sel;
      --  unspecified
   ...
   type PINTSEL0_Register is record
      ...
      --  Pin interrupt 0: Select the port for the pin number to be selected in
      --  the INTPIN0 bits of this register.
      PORTSEL0 : ENUM_23 := Interfaces.LPC43xxC.SCU.Gpio_Port_0;
      ...
      PORTSEL1 : ENUM_23 := Interfaces.LPC43xxC.SCU.Gpio_Port_0;
      ...
      PORTSEL2 : ENUM_23 := Interfaces.LPC43xxC.SCU.Gpio_Port_0;
      ...
      PORTSEL3 : ENUM_23 := Interfaces.LPC43xxC.SCU.Gpio_Port_0;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   type PINTSEL1_Register is record
      ...
      PORTSEL4 : ENUM_23 := Interfaces.LPC43xxC.SCU.Gpio_Port_0;
      ...
      PORTSEL5 : ENUM_23 := Interfaces.LPC43xxC.SCU.Gpio_Port_0;
      ...
      PORTSEL6 : ENUM_23 := Interfaces.LPC43xxC.SCU.Gpio_Port_0;
      ...
      PORTSEL7 : ENUM_23 := Interfaces.LPC43xxC.SCU.Gpio_Port_0;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
