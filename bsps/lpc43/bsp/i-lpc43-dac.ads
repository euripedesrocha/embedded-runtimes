...
package Interfaces.LPC43.DAC is
   pragma Preelaborate;
   ...
   type CR_Register is record
      ...
      --  Settling time
      BIAS       : ENUM := Interfaces.LPC43.DAC.Short;
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
   ...
   type CTRL_Register is record
      --  DMA request
      INT_DMA_REQ : ENUM_1 := Interfaces.LPC43.DAC.Clr;
      --  DMA double-buffering
      DBLBUF_ENA  : ENUM_2 := Interfaces.LPC43.DAC.Disabled;
      --  DMA time-out
      CNT_ENA     : ENUM_2 := Interfaces.LPC43.DAC.Disabled;
      --  DMA enable
      DMA_ENA     : ENUM_2 := Interfaces.LPC43.DAC.Disabled;
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
