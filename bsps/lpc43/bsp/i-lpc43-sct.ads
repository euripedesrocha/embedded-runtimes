...
package Interfaces.LPC43.SCT is
   pragma Preelaborate;
   ...
   type CONFIG_Register is record
      --  SCT operation
      UNIFY       : ENUM := Interfaces.LPC43.SCT.ENUM_16_Bit;
      --  SCT clock mode
      CLKMODE     : ENUM_1 := Interfaces.LPC43.SCT.Bus_Clock;
      --  SCT clock select
      CKSEL       : ENUM_2 := Interfaces.LPC43.SCT.Rising_Edges_On_Inpu;
   ...
   type CTRL_Register is record
      ...
      --  L or unified counter direction select
      BIDIR_L    : ENUM_3 := Interfaces.LPC43.SCT.Up;
      ...
      --  Direction select
      BIDIR_H    : ENUM_3 := Interfaces.LPC43.SCT.Up;
      --  Specifies the factor by which the SCT clock is prescaled to produce
   ...
   type RES_Register is record
      --  Effect of simultaneous set and clear on output 0.
      O0RES  : ENUM_5 := Interfaces.LPC43.SCT.No_Change;
      --  Effect of simultaneous set and clear on output 1.
      O1RES  : ENUM_5 := Interfaces.LPC43.SCT.No_Change;
      --  Effect of simultaneous set and clear on output 2.
      O2RES  : ENUM_6 := Interfaces.LPC43.SCT.No_Change;
      --  Effect of simultaneous set and clear on output 3.
      O3RES  : ENUM_5 := Interfaces.LPC43.SCT.No_Change;
      --  Effect of simultaneous set and clear on output 4.
      O4RES  : ENUM_5 := Interfaces.LPC43.SCT.No_Change;
      --  Effect of simultaneous set and clear on output 5.
      O5RES  : ENUM_5 := Interfaces.LPC43.SCT.No_Change;
      --  Effect of simultaneous set and clear on output 6.
      O6RES  : ENUM_5 := Interfaces.LPC43.SCT.No_Change;
      --  Effect of simultaneous set and clear on output 7.
      O7RES  : ENUM_5 := Interfaces.LPC43.SCT.No_Change;
      --  Effect of simultaneous set and clear on output 8.
      O8RES  : ENUM_5 := Interfaces.LPC43.SCT.No_Change;
      --  Effect of simultaneous set and clear on output 9.
      O9RES  : ENUM_5 := Interfaces.LPC43.SCT.No_Change;
      --  Effect of simultaneous set and clear on output 10.
      O10RES : ENUM_5 := Interfaces.LPC43.SCT.No_Change;
      --  Effect of simultaneous set and clear on output 11.
      O11RES : ENUM_5 := Interfaces.LPC43.SCT.No_Change;
      --  Effect of simultaneous set and clear on output 12.
      O12RES : ENUM_5 := Interfaces.LPC43.SCT.No_Change;
      --  Effect of simultaneous set and clear on output 13.
      O13RES : ENUM_5 := Interfaces.LPC43.SCT.No_Change;
      --  Effect of simultaneous set and clear on output 14.
      O14RES : ENUM_5 := Interfaces.LPC43.SCT.No_Change;
      --  Effect of simultaneous set and clear on output 15.
      O15RES : ENUM_5 := Interfaces.LPC43.SCT.No_Change;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   type EV_CTRL_Register is record
      ...
      --  Select L/H counter. Do not set this bit if UNIFY = 1.
      HEVENT    : ENUM_7 := Interfaces.LPC43.SCT.L_State;
      --  Input/output select
      OUTSEL    : ENUM_8 := Interfaces.LPC43.SCT.Input;
      ...
      IOCOND    : ENUM_9 := Interfaces.LPC43.SCT.Low;
      --  Selects how the specified match and I/O condition are used and
      --  combined.
      COMBMODE  : ENUM_10 := Interfaces.LPC43.SCT.Or_k;
      --  This bit controls how the STATEV value modifies the state selected by
      --  HEVENT when this event is the highest-numbered event occurring for
      --  that state.
      STATELD   : ENUM_11 := Interfaces.LPC43.SCT.Statev_Value_Is_Adde;
      ...
      DIRECTION : ENUM_12 := Interfaces.LPC43.SCT.Direction_Independen;
      --  Reserved
