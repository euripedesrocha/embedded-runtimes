...
package Interfaces.LPC43.USB1 is
   pragma Preelaborate;
   ...
   type USBCMD_D_Register is record
      --  Run/Stop
      RS         : ENUM := Interfaces.LPC43.USB1.Detach;
      ...
      RST        : ENUM_1 := Interfaces.LPC43.USB1.Resetcomplete;
   ...
   type USBCMD_H_Register is record
      --  Run/Stop
      RS         : ENUM_2 := Interfaces.LPC43.USB1.Halt;
      --  Controller reset. Software uses this bit to reset the controller.
      --  This bit is set to zero by the Host/Device Controller when the reset
      --  process is complete. Software cannot terminate the reset process
      --  early by writing a zero to this register.
      ...
      --  This bit controls whether the host controller skips processing the
      --  periodic schedule.
      PSE        : ENUM_3 := Interfaces.LPC43.USB1.Use_The_Periodiclist;
      --  This bit controls whether the host controller skips processing the
      --  asynchronous schedule.
      ASE        : ENUM_4 := Interfaces.LPC43.USB1.Use_The_Asynclistadd;
      --  This bit is used as a doorbell by software to tell the host
      --  controller to issue an interrupt the next time it advances
      --  asynchronous schedule.
      IAA        : ENUM_5 := Interfaces.LPC43.USB1.St;
      --  Reserved
      ...
      --  Asynchronous Schedule Park Mode Enable
      ASPE       : ENUM_6 := Interfaces.LPC43.USB1.Park_Mode_Is_Disable;
      --  Reserved.
   ...
   type USBSTS_D_Register is record
      --  USB interrupt
      UI         : ENUM_7 := Interfaces.LPC43.USB1.St;
      --  USB error interrupt
      UEI        : ENUM_7 := Interfaces.LPC43.USB1.St;
      --  Port change detect.
      PCI        : ENUM_7 := Interfaces.LPC43.USB1.St;
      --  Not used in Device mode.
      RESERVED   : USBSTS_D_RESERVED_Field :=
                    (As_Array => False, Val => 16#0#);
      --  USB reset received
      URI        : ENUM_7 := Interfaces.LPC43.USB1.St;
      --  SOF received
      SRI        : ENUM_7 := Interfaces.LPC43.USB1.St;
      --  DCSuspend
      SLI        : ENUM_7 := Interfaces.LPC43.USB1.St;
      ...
      RESERVED_2 : USBSTS_D_RESERVED_Field_2 :=
                    (As_Array => False, Val => 16#0#);
      --  NAK interrupt bit
      NAKI       : ENUM_8 := Interfaces.LPC43.USB1.Endpclear;
      --  Reserved. Software should only write 0 to reserved bits.
   ...
   type USBSTS_H_Register is record
      ...
      FRI        : ENUM_7 := Interfaces.LPC43.USB1.St;
      --  Reserved.
      RESERVED   : USBSTS_H_RESERVED_Field := 16#0#;
      --  Interrupt on async advance
      AAI        : ENUM_7 := Interfaces.LPC43.USB1.St;
      ...
      --  HCHalted
      HCH        : ENUM_9 := Interfaces.LPC43.USB1.Stop;
      --  Reclamation
      RCL        : ENUM_10 := Interfaces.LPC43.USB1.No_Empty_Asynchronou;
      ...
      PS         : ENUM_11 := Interfaces.LPC43.USB1.Disabled;
   ...
   type DEVICEADDR_Register is record
      ...
      --  Device address advance
      USBADRA  : ENUM_12 := Interfaces.LPC43.USB1.Advance;
      --  USB device address
   ...
   type ULPIVIEWPORT_Register is record
      ...
      --  ULPI sync state. This bit represents the state of the ULPI interface.
      ULPISS    : ENUM_13 := Interfaces.LPC43.USB1.In_Another_State;
      --  Reserved
      RESERVED  : ULPIVIEWPORT_RESERVED_Field := 16#0#;
      --  ULPI Read/Write control. This bit selects between running a read or
      --  write operation.
      ULPIRW    : ENUM_14 := Interfaces.LPC43.USB1.Read;
   ...
   type PORTSC1_D_Register is record
      --  Current connect status
      CCS        : ENUM_15 := Interfaces.LPC43.USB1.Device_Not_Attached;
      --  Not used in device mode
      ...
      --  one as well.
      FPR        : ENUM_16 := Interfaces.LPC43.USB1.No_Resume;
      --  Suspend In device mode, this is a read-only status bit .
      SUSP       : ENUM_17 := Interfaces.LPC43.USB1.Port_Not_In_Suspend;
      --  Port reset In device mode, this is a read-only status bit. A device
      --  reset from the USB bus is also indicated in the USBSTS register.
      PR         : ENUM_18 := Interfaces.LPC43.USB1.Port_Is_Not_In_The_R;
      --  High-speed status This bit is redundant with bits 27:26 (PSPD) in
      --  this register. It is implemented for compatibility reasons.
      HSP        : ENUM_19 := Interfaces.LPC43.USB1.Nohispeed;
      --  Not used in device mode.
      ...
      --  Port indicator control Writing to this field effects the value of the
      --  USB1_IND1:0 pins.
      PIC1_0     : ENUM_20 := Interfaces.LPC43.USB1.Off;
      ...
      PTC3_0     : ENUM_21 := Interfaces.LPC43.USB1.Test_Mode_Disable;
      ...
      PHCD       : ENUM_22 := Interfaces.LPC43.USB1.Enabled;
      --  Port force full speed connect
      PFSC       : ENUM_23 := Interfaces.LPC43.USB1.Anyspeed;
      --  Reserved
   ...
   type PORTSC1_H_Register is record
      ...
      CCS        : ENUM_26 := Interfaces.LPC43.USB1.No_Device_Is_Present;
      --  Connect status change Indicates a change has occurred in the port's
      ...
      CSC        : ENUM_27 := Interfaces.LPC43.USB1.No_Change_In_Current;
      ...
      PE         : ENUM_28 := Interfaces.LPC43.USB1.Port_Disabled;
      ...
      --  Power bit) is 0.
      PR         : ENUM_31 := Interfaces.LPC43.USB1.Not_In_Reset;
      --  High-speed status
      HSP        : ENUM_32 := Interfaces.LPC43.USB1.Nohighspeed;
      ...
      LS         : ENUM_33 := Interfaces.LPC43.USB1.Se0;
      ...
      PP         : ENUM_34 := Interfaces.LPC43.USB1.Port_Power_Off;
      --  Reserved
      ...
      PTC3_0     : ENUM_35 := Interfaces.LPC43.USB1.Test_Mode_Disable;
      --  Wake on connect enable (WKCNNT_E) This bit is 0 if PP (Port Power
      --  bit) is 0
      WKCN       : ENUM_36 := Interfaces.LPC43.USB1.Disables_The_Port_To;
      --  Wake on disconnect enable (WKDSCNNT_E) This bit is 0 if PP (Port
      --  Power bit) is 0.
      WKDC       : ENUM_36 := Interfaces.LPC43.USB1.Disables_The_Port_To;
      --  Wake on over-current enable (WKOC_E)
      WKOC       : ENUM_37 := Interfaces.LPC43.USB1.Disables_Overcurrent;
      ...
      --  connected. Low power suspend is completely under the control of
      --  software.
      PHCD       : ENUM_38 := Interfaces.LPC43.USB1.Enable_Phy_Clk;
      --  Port force full speed connect
      PFSC       : ENUM_23 := Interfaces.LPC43.USB1.Anyspeed;
      --  Reserved
      ...
      PSPD       : ENUM_39 := Interfaces.LPC43.USB1.Full_Speed;
      --  Reserved
   ...
   type USBMODE_D_Register is record
      ...
      CM1_0      : ENUM_40 := Interfaces.LPC43.USB1.Idle;
      --  Endian select This bit can change the byte ordering of the transfer
      --  buffers to match the host microprocessor bus architecture. The bit
      --  fields in the microprocessor interface and the DMA data structures
      ...
      ES         : ENUM_41 := Interfaces.LPC43.USB1.Little_Endian_First;
      --  Setup Lockout mode In device mode, this bit controls behavior of the
      --  setup lock mechanism. See Section 18.10.8.
      SLOM       : ENUM_42 := Interfaces.LPC43.USB1.Setup_Lockouts_On;
      --  Stream disable mode The use of this feature substantially limits the
      --  overall USB performance that can be achieved.
      SDIS       : ENUM_43 := Interfaces.LPC43.USB1.Not_Disabled;
      --  Not used in device mode.
   ...
   type USBMODE_H_Register is record
      ...
      --  Stream disable mode The use of this feature substantially limits the
      --  overall USB performance that can be achieved.
      SDIS       : ENUM_44 := Interfaces.LPC43.USB1.Not_Disabled;
      --  VBUS power select
      VBPS       : ENUM_45 := Interfaces.LPC43.USB1.Low;
      --  Reserved
   ...
   type ENDPTCTRL0_Register is record
      --  Rx endpoint stall
      RXS        : ENUM_46 := Interfaces.LPC43.USB1.Endpoint_Ok;
      --  Reserved
      ...
      --  Tx endpoint stall
      TXS        : ENUM_46 := Interfaces.LPC43.USB1.Endpoint_Ok;
      --  Reserved
   ...
   type ENDPTCTRL_Register is record
      --  Rx endpoint stall
      RXS        : ENUM_47 := Interfaces.LPC43.USB1.Endpoint_Ok_This_Bi;
      --  Reserved
      RESERVED   : ENDPTCTRL_RESERVED_Field := 16#0#;
      --  Endpoint type
      RXT        : ENUM_48 := Interfaces.LPC43.USB1.Control;
      --  Reserved
      ...
      RXI        : ENUM_11 := Interfaces.LPC43.USB1.Disabled;
      ...
      --  been configured.
      RXE        : ENUM_49 := Interfaces.LPC43.USB1.Endpoint_Disabled;
      --  Reserved
      RESERVED_2 : ENDPTCTRL_RESERVED_Field_1 := 16#0#;
      --  Tx endpoint stall
      TXS        : ENUM_47 := Interfaces.LPC43.USB1.Endpoint_Ok_This_Bi;
      --  Reserved
      RESERVED_3 : ENDPTCTRL_RESERVED_Field := 16#0#;
      --  Tx endpoint type
      TXT        : ENUM_50 := Interfaces.LPC43.USB1.Control;
      --  Reserved
      ...
      --  endpoint to ignore the data toggle sequence and always accept data
      --  packets regardless of their data PID.
      TXI        : ENUM_22 := Interfaces.LPC43.USB1.Enabled;
      ...
      --  been configured
      TXE        : ENUM_49 := Interfaces.LPC43.USB1.Endpoint_Disabled;
      --  Reserved
