...
package Interfaces.LPC43xxC.SGPIO is
   pragma Preelaborate;
   ...
   type OUT_MUX_CFG_Register is record
      --  Output control of output SGPIOn. All other values are reserved.
      P_OUT_CFG : ENUM := Interfaces.LPC43xxC.SGPIO.Dout_Doutm1;
      --  Output enable source. All other values are reserved.
      P_OE_CFG  : ENUM_1 := Interfaces.LPC43xxC.SGPIO.Gpio_Oe_State_Set_B;
      --  Reserved.
   ...
   type SGPIO_MUX_CFG_Register is record
      ...
      EXT_CLK_ENABLE        : ENUM_2 :=
                               Interfaces.LPC43xxC.SGPIO.Internal_Clock_Signa;
      --  Select source clock pin.
      CLK_SOURCE_PIN_MODE   : ENUM_3 := Interfaces.LPC43xxC.SGPIO.Sgpio8;
      --  Select clock source slice. Note that slices D, H, O and P do not
      --  support this mode.
      CLK_SOURCE_SLICE_MODE : ENUM_4 := Interfaces.LPC43xxC.SGPIO.Slice_D;
      --  Select qualifier mode.
      QUALIFIER_MODE        : ENUM_5 := Interfaces.LPC43xxC.SGPIO.Enable;
      --  Select qualifier pin.
      QUALIFIER_PIN_MODE    : ENUM_3 := Interfaces.LPC43xxC.SGPIO.Sgpio8;
      --  Select qualifier slice.
      QUALIFIER_SLICE_MODE  : ENUM_6 := Interfaces.LPC43xxC.SGPIO.Slice_A;
      --  Enable concatenation.
      CONCAT_ENABLE         : ENUM_7 :=
                               Interfaces.LPC43xxC.SGPIO.External_Data_Pin;
      --  Select concatenation order
      CONCAT_ORDER          : ENUM_8 := Interfaces.LPC43xxC.SGPIO.Self_Loop;
      --  Reserved
   ...
   type SLICE_MUX_CFG_Register is record
      ...
      --  data is captured.
      MATCH_MODE        : ENUM_9 :=
                           Interfaces.LPC43xxC.SGPIO.Do_Not_Match_Data;
      --  Capture clock mode
      CLK_CAPTURE_MODE  : ENUM_10 :=
                           Interfaces.LPC43xxC.SGPIO.Use_Rising_Clock_Edg;
      ...
      CLKGEN_MODE       : ENUM_11 :=
                           Interfaces.LPC43xxC.SGPIO.Use_Clock_Internally;
      --  Invert output clock
      INV_OUT_CLK       : ENUM_12 := Interfaces.LPC43xxC.SGPIO.Normal_Clock;
      --  Condition for input bit match interrupt
      DATA_CAPTURE_MODE : ENUM_13 :=
                           Interfaces.LPC43xxC.SGPIO.Detect_Rising_Edge;
      --  Parallel mode
      PARALLEL_MODE     : ENUM_14 :=
                           Interfaces.LPC43xxC.SGPIO.Shift_1_Bit_Per_Cloc;
      --  Inversion qualifier
      INV_QUALIFIER     : ENUM_15 :=
                           Interfaces.LPC43xxC.SGPIO.Use_Normal_Qualifier;
      --  Reserved.
