...
package Interfaces.LPC43xxC.UART1 is
   pragma Preelaborate;
   ...
   subtype IER_RESERVED_Field is Interfaces.Bit_Types.UInt3;
   subtype IER_RESERVED_Field_1 is Interfaces.Bit_Types.UInt22;
   ...
   type IER_Register is record
      ...
      CTSIE      : ENUM := Interfaces.LPC43xxC.UART1.Disable;
      --  Enables the end of auto-baud interrupt.
      ABEOIE     : ENUM := Interfaces.LPC43xxC.UART1.Disable;
      --  Enables the auto-baud time-out interrupt.
      ABTOIE     : ENUM := Interfaces.LPC43xxC.UART1.Disable;
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
   ...
   type FCR_Register is record
      ...
      FIFOEN     : ENUM_3 := Interfaces.LPC43xxC.UART1.Disabled;
      --  Write-only. RX FIFO Reset.
      RXFIFORES  : ENUM_4 := Interfaces.LPC43xxC.UART1.No_Effect;
      --  Write-only. TX FIFO Reset.
      TXFIFORES  : ENUM_4 := Interfaces.LPC43xxC.UART1.No_Effect;
      ...
      --  activated.
      RXTRIGLVL  : ENUM_5 := Interfaces.LPC43xxC.UART1.Level_0;
      --  Write-only. Reserved, user software should not write ones to reserved
      --  bits.
   ...
   type LCR_Register is record
      --  Word Length Select.
      WLS      : ENUM_6 :=
                  Interfaces.LPC43xxC.UART1.ENUM_5_Bit_Character_Leng;
      --  Stop Bit Select.
      SBS      : ENUM_7 := Interfaces.LPC43xxC.UART1.ENUM_1_Stop_Bit;
      --  Parity Enable.
      PE       : ENUM_8 := Interfaces.LPC43xxC.UART1.Disable_Parity_Gener;
      --  Parity Select.
      PS       : ENUM_9 := Interfaces.LPC43xxC.UART1.Odd_Parity;
      --  Break Control.
      BC       : ENUM_3 := Interfaces.LPC43xxC.UART1.Disabled;
      --  Divisor Latch Access Bit (DLAB)
      DLAB     : ENUM_3 := Interfaces.LPC43xxC.UART1.Disabled;
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
   ...
   subtype MCR_DTRCTRL_Field is Interfaces.Bit_Types.Bit;
   subtype MCR_RTSCTRL_Field is Interfaces.Bit_Types.Bit;
   subtype MCR_RESERVED_Field is Interfaces.Bit_Types.UInt2;
   subtype MCR_RESERVED_Field_1 is Interfaces.Bit_Types.Bit;
   subtype MCR_RESERVED_Field_2 is Interfaces.Bit_Types.UInt24;
   ...
   type MCR_Register is record
      ...
      LMS        : ENUM_3 := Interfaces.LPC43xxC.UART1.Disabled;
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
      RESERVED_1 : MCR_RESERVED_Field_1 := 16#0#;
      --  RTS enable.
      RTSEN      : ENUM_3 := Interfaces.LPC43xxC.UART1.Disabled;
      --  CTS enable.
      CTSEN      : ENUM_3 := Interfaces.LPC43xxC.UART1.Disabled;
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
   ...
   subtype LSR_RESERVED_Field is Interfaces.Bit_Types.UInt24;
   ...
   subtype MSR_CTS_Field is Interfaces.Bit_Types.Bit;
   subtype MSR_DSR_Field is Interfaces.Bit_Types.Bit;
   subtype MSR_RI_Field is Interfaces.Bit_Types.Bit;
   subtype MSR_DCD_Field is Interfaces.Bit_Types.Bit;
   subtype MSR_RESERVED_Field is Interfaces.Bit_Types.UInt24;
   ...
   type ACR_Register is record
      ...
      START       : ENUM_17 := Interfaces.LPC43xxC.UART1.Stop;
      --  Auto-baud mode select bit.
      MODE        : ENUM_18 := Interfaces.LPC43xxC.UART1.Mode_0;
      --  Auto-baud restart bit.
      AUTORESTART : ENUM_19 := Interfaces.LPC43xxC.UART1.No_Restart;
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
      RESERVED    : ACR_RESERVED_Field := 16#0#;
      --  End of auto-baud interrupt clear bit (write-only).
      ABEOINTCLR  : ENUM_4 := Interfaces.LPC43xxC.UART1.No_Effect;
      --  Auto-baud time-out interrupt clear bit (write-only).
      ABTOINTCLR  : ENUM_4 := Interfaces.LPC43xxC.UART1.No_Effect;
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
   ...
   subtype RS485CTRL_RESERVED_Field is Interfaces.Bit_Types.UInt26;
   ...
   type RS485CTRL_Register is record
      ...
      NMMEN    : ENUM_3 := Interfaces.LPC43xxC.UART1.Disabled;
      --  Receive enable.
      RXDIS    : ENUM_20 := Interfaces.LPC43xxC.UART1.Enabled;
      --  Auto Address Detect enable.
      AADEN    : ENUM_3 := Interfaces.LPC43xxC.UART1.Disabled;
      --  Direction control.
      SEL      : ENUM_21 := Interfaces.LPC43xxC.UART1.Rts;
      --  Direction control enable.
      DCTRL    : ENUM_3 := Interfaces.LPC43xxC.UART1.Disabled;
      --  Polarity. This bit reverses the polarity of the direction control
      --  signal on the RTS (or DTR) pin.
      OINV     : ENUM_22 := Interfaces.LPC43xxC.UART1.Low;
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
