...
package Interfaces.LPC43.SSP is
   pragma Preelaborate;
   ...
   type CR0_Register is record
      ...
      DSS      : ENUM := Enum_Reset;
      --  Frame Format.
      FRF      : ENUM_1 := Interfaces.LPC43.SSP.Spi;
      --  Clock Out Polarity. This bit is only used in SPI mode.
      CPOL     : ENUM_2 := Interfaces.LPC43.SSP.Bus_Low;
      --  Clock Out Phase. This bit is only used in SPI mode.
      CPHA     : ENUM_3 := Interfaces.LPC43.SSP.First_Clock;
   ...
   type CR1_Register is record
      --  Loop Back Mode.
      LBM      : ENUM_4 := Interfaces.LPC43.SSP.Normal;
      --  SSP Enable.
      SSE      : ENUM_5 := Interfaces.LPC43.SSP.Disabled;
      --  Master/Slave Mode.This bit can only be written when the SSE bit is 0.
      MS       : ENUM_6 := Interfaces.LPC43.SSP.Master;
