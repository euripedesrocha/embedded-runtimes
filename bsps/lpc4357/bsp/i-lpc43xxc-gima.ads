...
package Interfaces.LPC43xxC.GIMA is
   pragma Preelaborate;
   ...
   type CAP0_0_IN_Register is record
      --  Invert input
      INV      : ENUM := Interfaces.LPC43xxC.GIMA.Not_Inverted;
      --  Enable rising edge detection
      EDGE     : ENUM_1 := Interfaces.LPC43xxC.GIMA.No_Edge_Detection;
      --  Enable synchronization
      SYNCH    : ENUM_2 := Interfaces.LPC43xxC.GIMA.Disable_Synchroniz;
      --  Enable single pulse generation.
      PULSE    : ENUM_3 := Interfaces.LPC43xxC.GIMA.Disable_Single_Pulse;
      --  Select input. Values 0x3 to 0xF are reserved.
      SELECT_k : ENUM_4 := Interfaces.LPC43xxC.GIMA.Ctin_0;
      --  Reserved
   ...
   type CAP0_1_IN_Register is record
      ...
      PULSE    : ENUM_3 := Interfaces.LPC43xxC.GIMA.Disable_Single_Pulse;
      --  Select input. Values 0x3 to 0xF are reserved.
      SELECT_k : ENUM_5 := Interfaces.LPC43xxC.GIMA.Ctin_1;
      --  Reserved
   ...
   type CAP0_2_IN_Register is record
      ...
      PULSE    : ENUM_3 := Interfaces.LPC43xxC.GIMA.Disable_Single_Pulse;
      --  Select input. Values 0x3 to 0xF are reserved.
      SELECT_k : ENUM_6 := Interfaces.LPC43xxC.GIMA.Ctin_2;
      --  Reserved
   ...
   type CAP0_3_IN_Register is record
      ...
      PULSE    : ENUM_3 := Interfaces.LPC43xxC.GIMA.Disable_Single_Pulse;
      --  Select input. Values 0x3 to 0xF are reserved.
      SELECT_k : ENUM_7 := Interfaces.LPC43xxC.GIMA.Ctout_15_Or_T3_Mat3;
      --  Reserved
   ...
   type CAP1_0_IN_Register is record
      ...
      PULSE    : ENUM_3 := Interfaces.LPC43xxC.GIMA.Disable_Single_Pulse;
      --  Select input. Values 0x3 to 0xF are reserved.
      SELECT_k : ENUM_8 := Interfaces.LPC43xxC.GIMA.Ctin_0;
      --  Reserved
   ...
   type CAP1_1_IN_Register is record
      ...
      PULSE    : ENUM_3 := Interfaces.LPC43xxC.GIMA.Disable_Single_Pulse;
      --  Select input. Values 0x3 to 0xF are reserved.
      SELECT_k : ENUM_9 := Interfaces.LPC43xxC.GIMA.Ctin_3;
      --  Reserved
   ...
   type CAP1_2_IN_Register is record
      ...
      PULSE    : ENUM_3 := Interfaces.LPC43xxC.GIMA.Disable_Single_Pulse;
      --  Select input. Values 0x3 to 0xF are reserved.
      SELECT_k : ENUM_10 := Interfaces.LPC43xxC.GIMA.Ctin_4;
      --  Reserved
   ...
   type CAP1_3_IN_Register is record
      ...
      PULSE    : ENUM_3 := Interfaces.LPC43xxC.GIMA.Disable_Single_Pulse;
      --  Select input. Values 0x3 to 0xF are reserved.
      SELECT_k : ENUM_11 := Interfaces.LPC43xxC.GIMA.Ctout_3_Or_T0_Mat3;
      --  Reserved
   ...
   type CAP2_0_IN_Register is record
      ...
      PULSE    : ENUM_3 := Interfaces.LPC43xxC.GIMA.Disable_Single_Pulse;
      --  Select input. Values 0x4 to 0xF are reserved.
      SELECT_k : ENUM_12 := Interfaces.LPC43xxC.GIMA.Ctin_0;
      --  Reserved
   ...
   type CAP2_1_IN_Register is record
      ...
      PULSE    : ENUM_3 := Interfaces.LPC43xxC.GIMA.Disable_Single_Pulse;
      --  Select input. Values 0x4 to 0xF are reserved.
      SELECT_k : ENUM_13 := Interfaces.LPC43xxC.GIMA.Ctin_1;
      --  Reserved
   ...
   type CAP2_2_IN_Register is record
      ...
      PULSE    : ENUM_3 := Interfaces.LPC43xxC.GIMA.Disable_Single_Pulse;
      --  Select input. Values 0x4 to 0xF are reserved.
      SELECT_k : ENUM_14 := Interfaces.LPC43xxC.GIMA.Ctin_5;
      --  Reserved
   ...
   type CAP2_3_IN_Register is record
      ...
      PULSE    : ENUM_3 := Interfaces.LPC43xxC.GIMA.Disable_Single_Pulse;
      --  Select input. Values 0x3 to 0xF are reserved.
      SELECT_k : ENUM_15 := Interfaces.LPC43xxC.GIMA.Ctout_7_Or_T1_Mat3;
      --  Reserved
   ...
   type CAP3_0_IN_Register is record
      ...
      PULSE    : ENUM_3 := Interfaces.LPC43xxC.GIMA.Disable_Single_Pulse;
      --  Select input. Values 0x3 to 0xF are reserved.
      SELECT_k : ENUM_16 := Interfaces.LPC43xxC.GIMA.Ctin_0;
      --  Reserved
   ...
   type CAP3_1_IN_Register is record
      ...
      PULSE    : ENUM_3 := Interfaces.LPC43xxC.GIMA.Disable_Single_Pulse;
      --  Select input. Values 0x4 to 0xF are reserved.
      SELECT_k : ENUM_17 := Interfaces.LPC43xxC.GIMA.Ctin_6;
      --  Reserved
   ...
   type CAP3_2_IN_Register is record
      ...
      PULSE    : ENUM_3 := Interfaces.LPC43xxC.GIMA.Disable_Single_Pulse;
      --  Select input. Values 0x4 to 0xF are reserved.
      SELECT_k : ENUM_18 := Interfaces.LPC43xxC.GIMA.Ctin_7;
      --  Reserved
   ...
   type CAP3_3_IN_Register is record
      ...
      PULSE    : ENUM_3 := Interfaces.LPC43xxC.GIMA.Disable_Single_Pulse;
      --  Select input. Values 0x4 to 0xF are reserved.
      SELECT_k : ENUM_19 := Interfaces.LPC43xxC.GIMA.Ctout11_Or_T2_Mat3;
      --  Reserved
   ...
   type CTIN_0_IN_Register is record
      ...
      PULSE    : ENUM_3 := Interfaces.LPC43xxC.GIMA.Disable_Single_Pulse;
      --  Select input. Values 0x3 to 0xF are reserved.
      SELECT_k : ENUM_20 := Interfaces.LPC43xxC.GIMA.Ctin_0;
      --  Reserved
   ...
   type CTIN_1_IN_Register is record
      ...
      PULSE    : ENUM_3 := Interfaces.LPC43xxC.GIMA.Disable_Single_Pulse;
      --  Select input. Values 0x3 to 0xF are reserved.
      SELECT_k : ENUM_21 := Interfaces.LPC43xxC.GIMA.Ctin_1;
      --  Reserved
   ...
   type CTIN_2_IN_Register is record
      ...
      PULSE    : ENUM_3 := Interfaces.LPC43xxC.GIMA.Disable_Single_Pulse;
      --  Select input. Values 0x3 to 0xF are reserved.
      SELECT_k : ENUM_22 := Interfaces.LPC43xxC.GIMA.Ctin_2;
      --  Reserved
   ...
   type CTIN_3_IN_Register is record
      ...
      PULSE    : ENUM_3 := Interfaces.LPC43xxC.GIMA.Disable_Single_Pulse;
      --  Select input. Values 0x4 to 0xF are reserved.
      SELECT_k : ENUM_23 := Interfaces.LPC43xxC.GIMA.Ctin_3;
      --  Reserved
   ...
   type CTIN_4_IN_Register is record
      ...
      PULSE    : ENUM_3 := Interfaces.LPC43xxC.GIMA.Disable_Single_Pulse;
      --  Select input. Values 0x4 to 0xF are reserved.
      SELECT_k : ENUM_24 := Interfaces.LPC43xxC.GIMA.Ctin_4;
      --  Reserved
   ...
   type CTIN_5_IN_Register is record
      ...
      PULSE    : ENUM_3 := Interfaces.LPC43xxC.GIMA.Disable_Single_Pulse;
      --  Select input. Values 0x3 to 0xF are reserved.
      SELECT_k : ENUM_25 := Interfaces.LPC43xxC.GIMA.Ctin_5;
      --  Reserved
   ...
   type CTIN_6_IN_Register is record
      ...
      PULSE    : ENUM_3 := Interfaces.LPC43xxC.GIMA.Disable_Single_Pulse;
      --  Select input. Values 0x4 to 0xF are reserved.
      SELECT_k : ENUM_26 := Interfaces.LPC43xxC.GIMA.Ctin_6;
      --  Reserved
   ...
   type CTIN_7_IN_Register is record
      ...
      PULSE    : ENUM_3 := Interfaces.LPC43xxC.GIMA.Disable_Single_Pulse;
      --  Select input. Values 0x4 to 0xF are reserved.
      SELECT_k : ENUM_27 := Interfaces.LPC43xxC.GIMA.Ctin_7;
      --  Reserved
   ...
   type ADCHS_TRIGGER_IN_Register is record
      ...
      PULSE    : ENUM_3 := Interfaces.LPC43xxC.GIMA.Disable_Single_Pulse;
      --  Select input. Values 0xA to 0xF are reserved.
      SELECT_k : ENUM_28 := Interfaces.LPC43xxC.GIMA.Gpio6_28;
      --  Reserved
   ...
   type EVENTROUTER_13_IN_Register is record
      ...
      PULSE    : ENUM_3 := Interfaces.LPC43xxC.GIMA.Disable_Single_Pulse;
      --  Select input. Values 0x3 to 0xF are reserved.
      SELECT_k : ENUM_29 := Interfaces.LPC43xxC.GIMA.Ctout_2_Or_T0_Mat2;
      --  Reserved
   ...
   type EVENTROUTER_14_IN_Register is record
      ...
      PULSE    : ENUM_3 := Interfaces.LPC43xxC.GIMA.Disable_Single_Pulse;
      --  Select input. Values 0x3 to 0xF are reserved.
      SELECT_k : ENUM_30 := Interfaces.LPC43xxC.GIMA.Ctout_6_Or_T1_Mat2;
      --  Reserved
   ...
   type EVENTROUTER_16_IN_Register is record
      ...
      PULSE    : ENUM_3 := Interfaces.LPC43xxC.GIMA.Disable_Single_Pulse;
      --  Select input. Values 0x2 to 0xF are reserved.
      SELECT_k : ENUM_31 := Interfaces.LPC43xxC.GIMA.Ctout_14_Or_T3_Mat2;
      --  Reserved
   ...
   type ADCSTART0_IN_Register is record
      ...
      PULSE    : ENUM_3 := Interfaces.LPC43xxC.GIMA.Disable_Single_Pulse;
      --  Select input. Values 0x2 to 0xF are reserved.
      SELECT_k : ENUM_32 := Interfaces.LPC43xxC.GIMA.Ctout_15_Or_T3_Mat3;
      --  Reserved
   ...
   type ADCSTART1_IN_Register is record
      ...
      PULSE    : ENUM_3 := Interfaces.LPC43xxC.GIMA.Disable_Single_Pulse;
      --  Select input. Values 0x2 to 0xF are reserved.
      SELECT_k : ENUM_33 := Interfaces.LPC43xxC.GIMA.Ctout_8_Or_T2_Mat0;
      --  Reserved
