...
package Interfaces.LPC43.SDMMC is
   pragma Preelaborate;
   ...
   type CMD_Register is record
      ...
      --  used to query status of card during data transfer or to stop current
      --  data transfer; card_number should be same as in previous command.
      WAIT_PRVDATA_COMPLETE       : ENUM_16 := Interfaces.LPC43.SDMMC.Send;
      ...
      STOP_ABORT_CMD              : ENUM_7 := Interfaces.LPC43.SDMMC.Disabled;
      ...
      SEND_INITIALIZATION         : ENUM_17 := Interfaces.LPC43.SDMMC.No;
      ...
      UPDATE_CLOCK_REGISTERS_ONLY : ENUM_18 := Interfaces.LPC43.SDMMC.Normal;
      ...
      READ_CEATA_DEVICE           : ENUM_19 := Interfaces.LPC43.SDMMC.No_Read;
      ...
      CCS_EXPECTED                : ENUM_7 := Interfaces.LPC43.SDMMC.Disabled;
   ...
   type FIFOTH_Register is record
      ...
      --  RX_WMark = 7
      DMA_MTS    : ENUM_21 := Interfaces.LPC43.SDMMC.ENUM_1_Transfer;
      --  Reserved
   ...
   type BMOD_Register is record
      ...
      PBL      : ENUM_21 := Interfaces.LPC43.SDMMC.ENUM_1_Transfer;
      --  Reserved
