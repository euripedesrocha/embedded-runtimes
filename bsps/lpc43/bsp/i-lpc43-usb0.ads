...
package Interfaces.LPC43.USB0 is
   pragma Preelaborate;
   ...
   type USBCMD_D_Register is record
      --  Run/Stop
      RS         : ENUM := Interfaces.LPC43.USB0.Detach;
      ...
      RST        : ENUM_1 := Interfaces.LPC43.USB0.Resetcomplete;
   ...
   type USBCMD_H_Register is record
      --  Run/Stop
      RS         : ENUM_2 := Interfaces.LPC43.USB0.Halt;
      --  Controller reset. Software uses this bit to reset the controller.
      --  This bit is set to zero by the Host/Device Controller when the reset
      --  process is complete. Software cannot terminate the reset process
      --  early by writing a zero to this register.
      ...
      --  This bit controls whether the host controller skips processing the
      --  periodic schedule.
      PSE        : ENUM_3 := Interfaces.LPC43.USB0.Do_Not_Process_The_P;
      --  This bit controls whether the host controller skips processing the
      --  asynchronous schedule.
      ASE        : ENUM_4 := Interfaces.LPC43.USB0.Do_Not_Process_The_A;
      --  This bit is used as a doorbell by software to tell the host
      --  controller to issue an interrupt the next time it advances
      --  asynchronous schedule.
      IAA        : ENUM_5 := Interfaces.LPC43.USB0.The_Host_Controller;
      --  Reserved
      ...
      --  Asynchronous Schedule Park Mode Enable
      ASPE       : ENUM_6 := Interfaces.LPC43.USB0.Park_Mode_Is_Disable;
      --  Reserved.
   ...
   type USBSTS_D_Register is record
      --  USB interrupt
      UI         : ENUM_7 := Interfaces.LPC43.USB0.St;
      --  USB error interrupt
      UEI        : ENUM_7 := Interfaces.LPC43.USB0.St;
      --  Port change detect.
      PCI        : ENUM_7 := Interfaces.LPC43.USB0.St;
      --  Not used in Device mode.
      ...
      --  USB reset received
      URI        : ENUM_7 := Interfaces.LPC43.USB0.St;
      --  SOF received
      SRI        : ENUM_7 := Interfaces.LPC43.USB0.St;
      --  DCSuspend
      SLI        : ENUM_7 := Interfaces.LPC43.USB0.St;
      ...
      RESERVED_2 : USBSTS_D_RESERVED_Field_2 :=
                    (As_Array => False, Val => 16#0#);
      --  NAK interrupt bit
      NAKI       : ENUM_7 := Interfaces.LPC43.USB0.St;
      --  Reserved. Software should only write 0 to reserved bits.
   ...
   type USBSTS_H_Register is record
      ...
      FRI        : ENUM_7 := Interfaces.LPC43.USB0.St;
      --  Reserved.
      RESERVED   : USBSTS_H_RESERVED_Field := 16#0#;
      --  Interrupt on async advance
      AAI        : ENUM_7 := Interfaces.LPC43.USB0.St;
      ...
      --  HCHalted
      HCH        : ENUM_8 := Interfaces.LPC43.USB0.Rs;
      --  Reclamation
      RCL        : ENUM_9 := Interfaces.LPC43.USB0.No_Empty_Asynchronou;
      ...
      PS         : ENUM_10 := Interfaces.LPC43.USB0.Disabled;
   ...
   type DEVICEADDR_Register is record
      ...
      --  Device address advance
      USBADRA  : ENUM_11 := Interfaces.LPC43.USB0.Instantaneous;
      --  USB device address
   ...
   type PORTSC1_D_Register is record
      --  Current connect status
      CCS        : ENUM_12 := Interfaces.LPC43.USB0.Device_Not_Attached;
      --  Not used in device mode
      ...
      --  one as well.
      FPR        : ENUM_13 := Interfaces.LPC43.USB0.No_Resume;
      --  Suspend In device mode, this is a read-only status bit .
      SUSP       : ENUM_14 := Interfaces.LPC43.USB0.Port_Not_In_Suspend;
      --  Port reset In device mode, this is a read-only status bit. A device
      --  reset from the USB bus is also indicated in the USBSTS register.
      PR         : ENUM_15 := Interfaces.LPC43.USB0.Port_Is_Not_In_The_R;
      --  High-speed status This bit is redundant with bits 27:26 (PSPD) in
      --  this register. It is implemented for compatibility reasons.
      HSP        : ENUM_16 := Interfaces.LPC43.USB0.Not_Highsspeed;
      --  Not used in device mode.
      ...
      --  Port indicator control Writing to this field effects the value of the
      --  USB0_IND[1:0] pins.
      PIC1_0     : ENUM_17 := Interfaces.LPC43.USB0.Off;
      ...
      PTC3_0     : ENUM_18 := Interfaces.LPC43.USB0.Test_Mode_Disable;
      ...
      PHCD       : ENUM_19 := Interfaces.LPC43.USB0.Enable;
      --  Port force full speed connect
      PFSC       : ENUM_20 := Interfaces.LPC43.USB0.Anyspeed;
      --  reserved
      RESERVED_5 : PORTSC1_D_RESERVED_Field := 16#0#;
      --  Port speed This register field indicates the speed at which the port
      --  is operating.
      PSPD       : ENUM_21 := Interfaces.LPC43.USB0.Full_Speed;
      --  Reserved
   ...
   type PORTSC1_H_Register is record
      ...
      CCS            : ENUM_22 := Interfaces.LPC43.USB0.No_Device_Is_Present;
      --  Connect status change Indicates a change has occurred in the port's
      ...
      CSC            : ENUM_23 := Interfaces.LPC43.USB0.No_Change_In_Current;
      ...
      PE             : ENUM_24 := Interfaces.LPC43.USB0.Port_Disabled;
      ...
      PR             : ENUM_15 := Interfaces.LPC43.USB0.Port_Is_Not_In_The_R;
      --  High-speed status
      HSP            : ENUM_27 := Interfaces.LPC43.USB0.No_Hispeed;
      ...
      LS             : ENUM_28 := Interfaces.LPC43.USB0.Se0;
      --  Port power control Host/OTG controller requires port power control
      ...
      PP             : ENUM_29 := Interfaces.LPC43.USB0.Port_Power_Off;
      --  Reserved
      RESERVED       : PORTSC1_H_RESERVED_Field := 16#0#;
      --  Port indicator control Writing to this field effects the value of the
      --  pins USB0_IND1 and USB0_IND0.
      PIC1_0         : ENUM_30 := Interfaces.LPC43.USB0.Port_Indicators_Are;
      --  Port test control Any value other than 0000 indicates that the port
      --  is operating in test mode. The FORCE_ENABLE_FS and FORCE ENABLE_LS
      --  are extensions to the test mode support specified in the EHCI
      --  specification. Writing the PTC field to any of the
      ...
      PTC3_0         : ENUM_31 := Interfaces.LPC43.USB0.Test_Mode_Disable;
      --  Wake on connect enable (WKCNNT_E) This bit is 0 if PP (Port Power
      --  bit) is 0
      WKCN           : ENUM_32 := Interfaces.LPC43.USB0.Disables_The_Port_To;
      --  Wake on disconnect enable (WKDSCNNT_E) This bit is 0 if PP (Port
      --  Power bit) is 0.
      WKDC           : ENUM_32 := Interfaces.LPC43.USB0.Disables_The_Port_To;
      --  Wake on over-current enable (WKOC_E)
      WKOC           : ENUM_33 := Interfaces.LPC43.USB0.Disables_The_Port_To;
      ...
      --  connected. Low power suspend is completely under the control of
      --  software.
      PHCD           : ENUM_34 := Interfaces.LPC43.USB0.Writing_A_0_Enables;
      --  Port force full speed connect
      PFSC           : ENUM_35 := Interfaces.LPC43.USB0.Port_Connects_At_Any;
      --  Reserved
      ...
      PSPD           : ENUM_36 := Interfaces.LPC43.USB0.Full_Speed;
      --  unspecified
   ...
   type OTGSC_Register is record
      ...
      --  Hardware assist auto_reset
      HAAR       : ENUM_37 := Interfaces.LPC43.USB0.Disabled;
      ...
      --  ID pull-up. This bit provides control over the pull-up resistor.
      IDPU       : ENUM_38 := Interfaces.LPC43.USB0.Pull_Up_Off_The_Id;
      --  Hardware assist data pulse Write a 1 to start data pulse sequence.
      HADP       : OTGSC_HADP_Field := 16#0#;
      --  Hardware assist B-disconnect to A-connect
      HABA       : ENUM_39 := Interfaces.LPC43.USB0.Disabled;
      --  USB ID
      ID         : ENUM_40 := Interfaces.LPC43.USB0.A_Device;
   ...
   type USBMODE_D_Register is record
      ...
      CM1_0      : ENUM_41 := Interfaces.LPC43.USB0.Idle;
      --  Endian select This bit can change the byte ordering of the transfer
      --  buffers to match the host microprocessor bus architecture. The bit
      --  fields in the microprocessor interface and the DMA data structures
      ...
      ES         : ENUM_42 := Interfaces.LPC43.USB0.Little_Endian_First;
      --  Setup Lockout mode In device mode, this bit controls behavior of the
      --  setup lock mechanism. See Section 18.10.8.
      SLOM       : ENUM_43 := Interfaces.LPC43.USB0.Setup_Lockouts_On;
      --  Stream disable mode The use of this feature substantially limits the
      --  overall USB performance that can be achieved.
      SDIS       : ENUM_44 := Interfaces.LPC43.USB0.Not_Disabled;
      --  Not used in device mode.
   ...
   type USBMODE_H_Register is record
      ...
      --  switch modes, software must reset the controller by writing to the
      --  RESET bit in the USBCMD register before reprogramming this register.
      CM         : ENUM_41 := Interfaces.LPC43.USB0.Idle;
      --  Endian select This bit can change the byte ordering of the transfer
      ...
      --  Stream disable mode The use of this feature substantially limits the
      --  overall USB performance that can be achieved.
      SDIS       : ENUM_45 := Interfaces.LPC43.USB0.Not_Disabled;
      --  VBUS power select
      VBPS       : ENUM_46 := Interfaces.LPC43.USB0.Low;
      --  reserved
   ...
   type ENDPTCTRL0_Register is record
      --  Rx endpoint stall
      RXS        : ENUM_47 := Interfaces.LPC43.USB0.Endpoint_Ok;
      --  reserved
      ...
      --  Tx endpoint stall
      TXS        : ENUM_47 := Interfaces.LPC43.USB0.Endpoint_Ok;
      --  reserved
   ...
   type ENDPTCTRL_Register is record
      --  Rx endpoint stall
      RXS        : ENUM_48 := Interfaces.LPC43.USB0.Endpoint_Ok_This_Bi;
      --  Reserved
      RESERVED   : ENDPTCTRL_RESERVED_Field := 16#0#;
      --  Endpoint type
      RXT        : ENUM_49 := Interfaces.LPC43.USB0.Control;
      --  Reserved
      ...
      RXI        : ENUM_50 := Interfaces.LPC43.USB0.Disabled;
      ...
      --  been configured.
      RXE        : ENUM_51 := Interfaces.LPC43.USB0.Endpoint_Disabled;
      --  reserved
      RESERVED_2 : ENDPTCTRL_RESERVED_Field_1 := 16#0#;
      --  Tx endpoint stall
      TXS        : ENUM_48 := Interfaces.LPC43.USB0.Endpoint_Ok_This_Bi;
      --  Reserved
      RESERVED_3 : ENDPTCTRL_RESERVED_Field := 16#0#;
      --  Tx endpoint type
      TXT1_0     : ENUM_52 := Interfaces.LPC43.USB0.Control;
      --  reserved
      ...
      --  endpoint to ignore the data toggle sequence and always accept data
      --  packets regardless of their data PID.
      TXI        : ENUM_53 := Interfaces.LPC43.USB0.Enabled;
      ...
      --  been configured
      TXE        : ENUM_51 := Interfaces.LPC43.USB0.Endpoint_Disabled;
      --  reserved
