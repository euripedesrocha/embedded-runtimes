...
package Interfaces.LPC43.CCU2 is
   pragma Preelaborate;
   ...
   type PM_Register is record
      --  Initiate power-down mode
      PD       : ENUM := Interfaces.LPC43.CCU2.Normal_Operation;
      --  Reserved.
   ...
   type CLK_AUDIO_CFG_Register is record
      --  Run enable
      RUN      : ENUM_1 := Interfaces.LPC43.CCU2.Enabled;
      --  Auto (AHB disable mechanism) enable
      AUTO     : ENUM_1 := Interfaces.LPC43.CCU2.Disabled;
      --  Wake-up mechanism enable
      WAKEUP   : ENUM_1 := Interfaces.LPC43.CCU2.Disabled;
      --  Reserved.
