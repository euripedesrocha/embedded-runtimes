...
package Interfaces.LPC43.TIMER is
   pragma Preelaborate;
   ...
   type MCR_Register is record
      --  Interrupt on MR0
      MR0I     : ENUM := Interfaces.LPC43.TIMER.Disabled;
      --  Reset on MR0
      MR0R     : ENUM_1 := Interfaces.LPC43.TIMER.Disabled;
      --  Stop on MR0
      MR0S     : ENUM_2 := Interfaces.LPC43.TIMER.Disabled;
      --  Interrupt on MR1
      MR1I     : ENUM_2 := Interfaces.LPC43.TIMER.Disabled;
      --  Reset on MR1
      MR1R     : ENUM_1 := Interfaces.LPC43.TIMER.Disabled;
      --  Stop on MR1
      MR1S     : ENUM_3 := Interfaces.LPC43.TIMER.Disabled;
      --  Interrupt on MR2
      MR2I     : ENUM_2 := Interfaces.LPC43.TIMER.Disabled;
      --  Reset on MR2
      MR2R     : ENUM_2 := Interfaces.LPC43.TIMER.Disabled;
      --  Stop on MR2.
      MR2S     : ENUM_3 := Interfaces.LPC43.TIMER.Disabled;
      --  Interrupt on MR3
      MR3I     : ENUM_4 := Interfaces.LPC43.TIMER.Disabled;
      --  Reset on MR3
      MR3R     : ENUM_2 := Interfaces.LPC43.TIMER.Disabled;
      --  Stop on MR3
      MR3S     : ENUM_3 := Interfaces.LPC43.TIMER.Disabled;
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
   ...
   type CCR_Register is record
      --  Capture on CAPn.0 rising edge
      CAP0RE   : ENUM_5 := Interfaces.LPC43.TIMER.Disabled;
      --  Capture on CAPn.0 falling edge
      CAP0FE   : ENUM_6 := Interfaces.LPC43.TIMER.Disabled;
      --  Interrupt on CAPn.0 event
      CAP0I    : ENUM_7 := Interfaces.LPC43.TIMER.Disabled;
      --  Capture on CAPn.1 rising edge
      CAP1RE   : ENUM_5 := Interfaces.LPC43.TIMER.Disabled;
      --  Capture on CAPn.1 falling edge
      CAP1FE   : ENUM_6 := Interfaces.LPC43.TIMER.Disabled;
      --  Interrupt on CAPn.1 event
      CAP1I    : ENUM_7 := Interfaces.LPC43.TIMER.Disabled;
      --  Capture on CAPn.2 rising edge
      CAP2RE   : ENUM_5 := Interfaces.LPC43.TIMER.Disabled;
      --  Capture on CAPn.2 falling edge:
      CAP2FE   : ENUM_6 := Interfaces.LPC43.TIMER.Disabled;
      --  Interrupt on CAPn.2 event
      CAP2I    : ENUM_7 := Interfaces.LPC43.TIMER.Disabled;
      --  Capture on CAPn.3 rising edge
      CAP3RE   : ENUM_5 := Interfaces.LPC43.TIMER.Disabled;
      --  High to low. Capture on CAPn.3 falling edge
      CAP3FE   : ENUM_6 := Interfaces.LPC43.TIMER.Disabled;
      --  Interrupt on CAPn.3 event:
      CAP3I    : ENUM_7 := Interfaces.LPC43.TIMER.Disabled;
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
   ...
   type CTCR_Register is record
      ...
      CTMODE   : ENUM_9 := Interfaces.LPC43.TIMER.Timer_Mode;
      ...
      CINSEL   : ENUM_10 := Interfaces.LPC43.TIMER.Cap0;
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
